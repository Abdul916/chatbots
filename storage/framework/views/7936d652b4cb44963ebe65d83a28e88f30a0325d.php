...
<script type="text/javascript">
	...
	$('#submit').click(function(e){
		if($("#change_password_form").valid()){
			...
			$.ajax({
				url:'<?php echo e(url('admin/update_password')); ?>',
				type:'post',
				data:value,
				dataType:'json',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.admin_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\wamp64\www\chatbots\resources\views/admin/change_password.blade.php ENDPATH**/ ?>